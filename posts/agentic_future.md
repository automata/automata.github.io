...
But written language was a powerful invention.

Computers are all about language. The way we evolved them from typewriters to dumb keyboards connected to green
flickering terminals, connected to mainframes, processing symbols, storing them, converting them to lower and 
lower levels of languages.

And now we have LLMs. Large Language Models.

We created GUIs on top of those commands but in the end, what really matters is the information, the data.
And agents trill on data.
...
Researcher.
- Today: 
- Tomorrow: wants to understand a given behaviour. Open its cellphone, 
